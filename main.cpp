...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader(RESOURCES_PATH "texture.vs", RESOURCES_PATH "texture.fss");
	Shader lightCubeShader(RESOURCES_PATH "light_cube.vs", RESOURCES_PATH "light_cube.fss");

    //load 
    unsigned int diffuseMap = load_image(RESOURCES_PATH "container2.png");
    unsigned int specularMap = load_image(RESOURCES_PATH "container2_specular.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::SliderFloat("Shininess", &f, 12.0f, 256.0f);
        ...
        lightingShader.setFloat("material.shininess", f);
